  ...
  <UContainer class="py-8">
    <div class="flex justify-between items-end mb-8 pl-1">
      <div>
        ...
        <p class="text-slate-500 mt-1">Manage issues and their page layouts.</p>
      </div>
      <UButton
        icon="i-lucide-plus"
        label="New Issue"
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
      ...
      >
        <div class="flex items-center justify-between mb-4">
          ...
          <UIcon name="i-lucide-chevron-right" class="w-5 h-5 text-slate-400" />
        </div>
        ...
        <div class="p-6 flex flex-col gap-4">
          <div class="flex gap-4">
             <div class="flex-1">
               ...
               <UInput v-model.number="year" type="number" />
             </div>
             <div class="flex-1">
          ...
          <div>
            ...
            <UInput v-model="releaseDate" type="date" />
          </div>
          <div class="flex justify-end gap-3 mt-4">
            <UButton variant="ghost" color="neutral" @click="isModalOpen = false">Cancel</UButton>
            <UButton color="primary" @click="onCreate" :disabled="!releaseDate">Create Issue</UButton>
          </div>
        </div>
      </template>
    </UModal>
